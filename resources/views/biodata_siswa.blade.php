                    ...
                    <br><br><br>
                    <a href="registersiswa" class="buttona">INPUT BIODATA SISWA BARU</a>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $p->password }}</td>
                                <td>
                                    <a href="/biodata_siswa/edit/{{ $p->id }}" class="button">Edit</a><br><br>
                                    <a href="/biodata_siswa/hapus/{{ $p->id }}" class="button">Hapus</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
