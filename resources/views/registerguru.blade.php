...
@if ($errors->any())
            ...
            @endif
<form action="{{ url('/registerPostGuru') }}" method="post">
{{ csrf_field() }}
  <div class="container">
  <a href="/loginguru" class="btncancel">Cancel</a><br>
    <h1>Register</h1>
    <hr>
    ...
    <label for="alamat_guru"><b>Alamat</b></label>
    <textarea name="alamat_guru" placeholder="Masukkan Alamat" id="alamat_guru" name="alamat_guru" required></textarea> 

    <label for="telepon_guru"><b>Telepon</b></label>
    <input type="text" placeholder="Masukkan Telepon" id="telepon_guru" name="telepon_guru" required> 

    <label for="jenis_kelamin_guru"><b>Jenis Kelamin</b></label><br><br>
